...
DebugWindow.Settings.LogFilters[ SystemData.UiLogFilters.SYSTEM ]   = { enabled=false,   color=DefaultColor.MAGENTA }
DebugWindow.Settings.LogFilters[ SystemData.UiLogFilters.WARNING ]  = { enabled=false,   color=DefaultColor.ORANGE }
DebugWindow.Settings.LogFilters[ SystemData.UiLogFilters.ERROR ]    = { enabled=false,   color=DefaultColor.RED }
DebugWindow.Settings.LogFilters[ SystemData.UiLogFilters.DEBUG ]    = { enabled=false,   color=DefaultColor.YELLOW }
...
DebugWindow.Settings.LogFilters[9] = { enabled=false,  color=DefaultColor.MAGENTA }
DebugWindow.Settings.LogFilters[10] = { enabled=false,  color=DefaultColor.LIGHT_BLUE }
DebugWindow.Settings.LogFilters[11] = { enabled=false,  color=DefaultColor.GOLD }
